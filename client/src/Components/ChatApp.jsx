...
const ChatApp = () => {
	...
	const generateResponse = async (userPrompt, sessionId, history = [], generateImage = false) => {
		const payload = {
			prompt: userPrompt,
	...
	const regenerateImage = async () => {
		...
		try {
			...
			const aiResponse = await generateResponse(lastUserMessage.text, sessionId(), conversationHistory, true);
	...
	const handleSubmit = async (e) => {
		...
		const generateImage = document.getElementById("generateImageCheckbox")?.checked;
		...
		try {
			...
			const aiResponse = await generateResponse(userInput, sessionId(), conversationHistory, generateImage);
